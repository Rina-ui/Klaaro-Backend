...
class KlaaroMLService:
    def __init__(self):
        # Les modèles lourds restent bien commentés / supprimés ici !
        print("🚀 MODE TEST LOCAL ACTIVÉ : Modèles IA désactivés")

    # ... (tes autres méthodes mockées si tu les as gardées) ...

# 🎯 IL FAUT ABSOLUMENT CETTE LIGNE TOUT EN BAS :
ml_service = KlaaroMLService()